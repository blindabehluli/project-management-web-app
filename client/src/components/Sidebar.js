    ...
    <>
      <aside className={isSidebarHidden ? "aside-hide" : ""}>
        <div className="sidebar-top">
          <div className="sidebar-head font-bold">All Boards (4)</div>
          <div>
            <button className="sidebar-tab active">Product Design</button>
            <button className="sidebar-tab">Develop Launch</button>
          </div>
          <button className="sidebar-tab add-new">+ Create New Board</button>
        </div>
