    ...
    <main className="flex justify-center items-center w-screen h-screen">
      <div className="container lg:px-28 px-6 md:px-12">
        <div className="flex flex-col justify-center align-center text-center">
          <div className="text-[#303030] border border-dashed border-[#EAEAEA] p-8 break-words">
            <h1
          ...
          <div className="border-x max-w-full border-[#EAEAEA] border-dashed p-10">
          ...
          <div className="flex justify-center border border-dashed border-[#EAEAEA]">
